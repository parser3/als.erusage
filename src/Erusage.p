###########################################################################
# $Id: Als/Erusage.p,v 1.5 2009-03-15 01:32:31 misha Exp $
###########################################################################
#
# Usage:
# Firts call: ^Als/Erusage:init[$.iLimit(2048)] (can be omited)
# Others calls: ^Als/Erusage:compact[]
# Real ^memory:compact[] will be called if used more then $iLimit KB since last compact
#  or if $.bForce(1) option is specified.
#
# At the end (in @postprocess for ex.) you can analize statistics or call ^Als/Erusage:log[] or ^Als/Erusage:print[].
